...
ALTER TABEL_STORE ADD CONSTRAINT FK_TABEL_STORE_TENANT FOREIGN KEY (TENANT_ID) REFERENCES TENANT(ID) ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABEL_STORE ADD CONSTRAINT FK_TABEL_STORE_TAG FOREIGN KEY (TAG_ID) REFERENCES TAG(ID) ON DELETE SET NULL ON UPDATE CASCADE;
ALTER TABEL_STORE ADD CONSTRAINT FK_TABEL_STORE_CATEGORY FOREIGN KEY (CATEGORY_ID) REFERENCES CATEGORY(ID) ON DELETE SET NULL ON UPDATE CASCADE;
