...
CREATE DOMAIN DN_BOOLEAN AS
SMALLINT
DEFAULT 0
NOT NULL
CHECK (VALUE IN (0,1));

COMMENT ON DOMAIN DN_BOOLEAN IS
...
CREATE TABLE ROLES (
  ...
  SETUP               DN_BOOLEAN,
  MEMBERS             DN_BOOLEAN,
  ACTIVITY_RECORDING  DN_BOOLEAN,
  SEPA                DN_BOOLEAN,
  BILLING             DN_BOOLEAN,
  IMPORT              DN_BOOLEAN,
  EXPORT              DN_BOOLEAN,
  REFERENCE_DATA      DN_BOOLEAN,
  REPORTING           DN_BOOLEAN,
  MISC                DN_BOOLEAN,
  FILERESOURCE        DN_BOOLEAN,
  CLOSESESSION        DN_BOOLEAN DEFAULT 1,
  FIND                DN_BOOLEAN DEFAULT 1,
  DONOTDELETE         DN_BOOLEAN,
  SOFTDEL             DN_BOOLEAN,    
  CRE_USER            VARCHAR(32) NOT NULL,
  CRE_DATE            TIMESTAMP NOT NULL,
...
CREATE OR ALTER PROCEDURE SP_CREATE_RELATION_TABLE (
  ...
  ADO_CREATE_PRIMARY_KEY DN_BOOLEAN)
RETURNS (
  success smallint,
...
declare variable do_create_primary_key DN_BOOLEAN;
