...
public class AddressBook extends com.wavemaker.runtime.javaservice.JavaServiceSuperClass {
  ...
  public List<Results.ProcResults> testProc(Integer aTenantId,
    ...
    try {
      if (isAuthentic) {
        result = session.createSQLQuery("select * from SP_TESTPROC(:SESSIONID, :USERNAME, :IP, :TENANTID, :INTEGERPARAM, :SMALLINTPARAM, :VARCHAR254PARAM, :VARSCHAR2000PARAM, :DATEPARAM)")
            .addScalar("success",
              Hibernate.INTEGER)
            .addScalar("code",
              Hibernate.INTEGER)
            ...
            .setParameter("TENANTID",
              aTenantId)
            .setParameter("INTEGERPARAM",
              aInteger)
            .setParameter("SMALLINTPARAM",
              aSmallInt)
            .setParameter("VARCHAR254PARAM",
              aVarchar254)
            .setParameter("VARSCHAR2000PARAM",
              aVarchar2000)
            .setParameter("DATEPARAM",
              aDate)
  ...
  protected String getUniqueName(Integer aTenantId,
    String aExt) {

    String result = "";
    String errorMsg = "";

    List<Results.ProcResults> uniqRes = getUniqueNameByDb(aTenantId,
      aExt);
    if (uniqRes.size() > 0) {
      if (uniqRes.get(0)
          .getSuccess() == 1) {
        try {
          result = JSONDataManager.getInstance()
              .getStringByIdent(uniqRes.get(0),
                "uniquename");
        } catch (RuntimeException ex) {
          if (ex.getCause()
              .equals(null)) {
  ...
  public List<Results.ProcResults> addAddressBookItem(Integer aTenantId,
    Integer aSalutationId,
    String aAltsalutation,
    Integer aTitelId,
    String aFirstName,
    String aName,
    String aName2,
    Date aDayOfBirth,
    Boolean aIsPrivatePerson,
    Boolean aIsMarried,
    Integer aMarriedToId,
    Date aMarriedSince,
    String aMarriagePartnerFirstName,
    String aMarriagePartnerName1,
    Boolean aAddressDataPresent,
    Integer aAddressTypeId,
    String aDistrict,
    String aZipcode,
    String aCity,
    String aPostOfficeBox,
    String aStreet,
    String aStreetAddressFrom,
    String aStreetAddressTo,
    Boolean aIsPostAddress,
    Boolean aIsPrivateAddress,
    Boolean aContactDataPresent,
    Integer aContactTypeId,
    String aAreaCode,
    String aPhoneFmt,
    String aFaxFmt,
    String aWWW,
    String aEmail,
    String aSkype,
    String aMessangerName,
    Boolean aBankDataPresent,
    String aDepositor,
    String aBlzFmt,
    String aKtoFmt,
    String aIBAN,
    String aBIC,
    Boolean aInfoDataPresent,
    String aInfo,
    Boolean aPhotoPresent,
    String aPhotoUniqueName,
    String aPhotoRealName) {
    ...
    try {
      if (isAuthentic) {
        result = session.createSQLQuery("select * from SP_ADD_ADDRESSBOOKITEM_BY_SRV(:SESSIONID, " + ":USERNAME, "
                                        + ":IP, "
                                        + ":TENANTID, "
                                        + ":SALUTATION_ID, "
                                        + ":ALTSALUTATION, "
            ...
            .setParameter("TENANTID",
              aTenantId)
            .setParameter("SALUTATION_ID",
              aSalutationId)
            .setParameter("ALTSALUTATION",
              aAltsalutation)
            .setParameter("TITEL_ID",
              aTitelId)
            ...
            .setParameter("NAME2",
              aName2)
            .setParameter("DAY_OF_BIRTH",
              aDayOfBirth)
            .setParameter("ISPRIVATE_PERSON",
              aIsPrivatePerson_smallint)
            .setParameter("ISMARRIED",
              aIsMarried_smallint)
            .setParameter("MARRIED_TO_ID",
              aMarriedToId)
            .setParameter("MARRIED_SINCE",
              aMarriedSince)
            .setParameter("MARRIAGE_PARTNER_FIRSTNAME",
              aMarriagePartnerFirstName)
            .setParameter("MARRIAGE_PARTNER_NAME1",
              aMarriagePartnerName1)
            .setParameter("ADDRESSDATAPRESENT",
              aAddressDataPresent_smallint)
            .setParameter("ADDRESS_TYPE_ID",
              aAddressTypeId)
            ...
            .setParameter("CITY",
              aCity)
            .setParameter("POST_OFFICE_BOX",
              aPostOfficeBox)
            .setParameter("STREET",
              aStreet)
            .setParameter("STREET_ADDRESS_FROM",
              aStreetAddressFrom)
            .setParameter("STREET_ADDRESS_TO",
              aStreetAddressTo)
            .setParameter("ISPOSTADDRESS",
              aIsPostAddress_smallint)
            .setParameter("ISPRIVATE_ADDRESS",
              aIsPrivateAddress_smallint)
            .setParameter("CONTACTDATAPRESENT",
              aContactDataPresent_smallint)
            .setParameter("CONTACT_TYPE_ID",
              aContactTypeId)
            .setParameter("AREA_CODE",
              aAreaCode)
            .setParameter("PHONE_FMT",
              aPhoneFmt)
            .setParameter("FAX_FMT",
              aFaxFmt)
            .setParameter("WWW",
              aWWW)
            .setParameter("EMAIL",
            ...
            .setParameter("SKYPE",
              aSkype)
            .setParameter("MESSANGERNAME",
              aMessangerName)
            .setParameter("BANKDATAPRESENT",
              aBankDataPresent_smallint)
            .setParameter("DEPOSITOR",
              aDepositor)
            .setParameter("BLZ_FMT",
              aBlzFmt)
            .setParameter("KTO_FMT",
              aKtoFmt)
            .setParameter("IBAN",
              aIBAN)
            .setParameter("BIC",
              aBIC)
            .setParameter("INFODATAPRESENT",
              aInfoDataPresent_smallint)
            .setParameter("INFO",
              aInfo)
            .setParameter("PHOTOPRESENT",
              aPhotoPresent_smallint)
            .setParameter("PHOTO_UNIQUE_NAME",
              aPhotoUniqueName)
            .setParameter("PHOTO_REAL_NAME",
              aPhotoRealName)
            .setParameter("PHOTO_EXT",
              fileExt)
            .setResultTransformer(Transformers.aliasToBean(Results.ProcResults.class))
        ...
        if (result.size() > 0) {
          if (result.get(0)
              .getSuccess() == 1) {
            if (aPhotoPresent_smallint == 1) {
              uniqueName = JSONDataManager.getInstance()
                  .getStringByIdent(result.get(0),
                    "uniquename");
              if (!uniqueName.trim()
                  .isEmpty()) {
