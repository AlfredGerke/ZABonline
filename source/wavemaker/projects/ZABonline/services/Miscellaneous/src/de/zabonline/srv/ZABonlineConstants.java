...
public class ZABonlineConstants {
  ...
  /**
   */
  public final static String UNKNOWN_ERROR_BY_DBSERVICE = "UNKNOWN_ERROR_BY_DBSERVICE";
  /**
   */
  public final static String NO_VALID_AUTHENTIFICATION = "NO_VALID_AUTHENTIFICATION";
  /**
   */
  public final static String NO_VALID_UNIQUENAME = "NO_VALID_UNIQUENAME";
  /**
   */
