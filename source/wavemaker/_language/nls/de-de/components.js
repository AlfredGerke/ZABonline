...
"wm.Variable.TYPE_INVALID": "A variable of type<code>${type}</code> named <code>${name}</code> has been created, but that type does not exist. To learn more about how to fix this type of error, please see our <a target='_NewWindow' href='http://dev.wavemaker.com/wiki/bin/Variables#HTypes'>documentation</a> on the topic",
...
"wm.Application.TITLE_ALERT": "Alert!",
"wm.Application.CAPTION_ALERT_OK": "OK",
"wm.Application.CAPTION_CONFIRM_OK": "OK",
"wm.Application.CAPTION_CONFIRM_CANCEL": "Cancel",
"wm.Application.TITLE_CONFIRM": "Confirm...",
"wm.Application.TITLE_PROMPT": "Prompt...",

"wm.Toast.STATUS_INFO": "Information",
"wm.Toast.STATUS_ERROR": "Error",
"wm.Toast.STATUS_WARNING": "Warning",
"wm.Toast.STATUS_SUCCESS": "Success",

"wm.LogoutVariable.FAILED": "Failed to logout: ${error}",

"wm.Page.PAGE_ERRORS": "Page ${name} has errors",
...
"wm.Dialog.HINT_MAXIFY": "Enlarge dialog",
"wm.PageDialog.CAPTION_CLOSE": "Close",

"wm.WizardDecorator.BACK": "Zur&uuml;ck",
"wm.WizardDecorator.NEXT": "Weiter",
"wm.WizardDecorator.DONE": "Beenden",
"wm.WizardDecorator.CANCEL": "Abbruch",
"wm.WizardDecorator.VALIDATION_INVALID_INPUT": "Ung&uuml;ltiege Eingabe",
"wm.WizardDecorator.TOAST_INVALID": "Ung&uuml;ltige Eingabe von ${name}",
"wm.WizardDecorator.ALERT_INCOMPLETE": "Der Vorgang ist nicht komplett",
"wm.WizardDecorator.TOAST_PLEASE_FILL": "Zuerst \"${name}\" ausfüllen",
"wm.WizardDecorator.TOAST_SKIP_LAYER": "Zuerst \"${name}\" aufrufen",
